...
6. [Perfect Cast (experimental)](perfect-cast.md) — camera-force sequence + fill-%-based M1 release; needs per-setup tuning
7. [Troubleshooting](troubleshooting.md) — common failure modes and fixes
8. [Advanced: Per-Rod Tuning](advanced.md) — per-rod color overrides, arrow-color reference table, hand-editing config.json
...
| `bar_arrow_color` | `#848587` | medium grey — works for the majority of rods |
...
| `perfect_cast.enabled` | off | Experimental; opt-in via Cast tab after region pick |
