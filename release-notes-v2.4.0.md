...
> **Three follow-up UX fixes** (license activation flow, dialog dark theming, premium-tab gating) shipped a few hours later as **[v2.4.1](release-notes-v2.4.1.md)**. New users should grab v2.4.1 directly.
